...
import '../components/blockly/blocklyapi';
...
`<xml id="toolbox" style="display: none">
  ...
  <category name="Loops" colour="#5ba55b">
    ...
    <block type="controls_for">
      <field name="VAR" id="}D+8w2H0zq?Hj2WN-g|:">i</field>
      <value name="FROM">
        <shadow type="math_number">
    ...
    <block type="controls_forEach">
      <field name="VAR" id="[-6}LEkf*k04[Jl)}.ad">j</field>
    </block>
  ...
  <category name="Text" colour="#5ba58c">
    ...
    <block type="text_append">
      <field name="VAR" id="Fyq#cWl~Hq%KR%Lvc(S7">item</field>
      <value name="TEXT">
        <shadow type="text">
          <field name="TEXT"></field>
        </shadow>
    ...
    <block type="text_indexOf">
      ...
      <value name="VALUE">
        <block type="variables_get">
          <field name="VAR" id="R=FlNG,MTBobSXl}]a{D">text</field>
        </block>
      </value>
      <value name="FIND">
        <shadow type="text">
  ...
  <category name="Lists" colour="#745ba5">
    ...
    <block type="lists_indexOf">
      ...
      <value name="VALUE">
        <block type="variables_get">
          <field name="VAR" id="aW}y~$(WZ89bhB[6DB~V">list</field>
        </block>
      </value>
    </block>
  ...
  <sep></sep>
  <category name="HelloBlocks" colour="%{BKY_LOOPS_HUE}">
  ...
  media: 'media/',
  grid: {
    spacing: 15, length: 2, colour: '#a2c9d4', snap: true,
  },
};
